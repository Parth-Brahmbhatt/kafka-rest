...
public class SubmissionHandlerTest {
    ...
    public void testSetFields() throws Exception {
        ...
        RestApiMessage.Builder builder = RestApiMessage.newBuilder();
        RestApiMessage before = builder.buildPartial();
        ...
        KafkaRestApiHttpRequest request = Mockito.mock(KafkaRestApiHttpRequest.class);
        ...
        RestApiMessage after = builder.build();
        ...
        builder = RestApiMessage.newBuilder();
