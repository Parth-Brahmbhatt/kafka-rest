 ...
 */
package org.apache.kafka.rest.metrics;
...
public class MetricsManager {
    private static final String DEFAULT_METRICS_PROPERTIES_RESOURCE_NAME = "/restapi.metrics.properties";
    private static final String DEFAULT_METRICS_PROPERTIES_PREFIX = "restapi.metrics.";
