...
public class KafkaRestApiHttpRequest extends DefaultHttpRequest {
    ...
    public KafkaRestApiHttpRequest(HttpVersion httpVersion, HttpMethod method, String uri) {
        this(httpVersion, method, uri, new PathDecoder(uri));
    }

    public KafkaRestApiHttpRequest(HttpRequest request) {
